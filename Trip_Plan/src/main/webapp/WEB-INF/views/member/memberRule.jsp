...
<body>
<strong>[Trip plan의 개인 정보 수집 및 이용 안내]</strong>


			<h5>개인 정보 제3자 제공 동의</h5>
			<br>① 개인정보를 제공받는 자: Trip plan
			...
			<br>귀하는 위와 같은 trip plan의 개인정보 수집 및 이용정책에 동의하지 
			않을 수 있으나, trip plan으로부터 솔루션, 최신 여행정보, 행사초청안내 등의 
			유용한 정보를 제공받지 못 할 수 있습니다.
			<br> 개인 정보 보호에 대한 자세한 내용은 http://www.tripplan.com 을 참조바랍니다.
</body>
</html>