...
<div class="container text-center">
	...
	<script>
		...
		var options = {
			center: new kakao.maps.LatLng(35.87361219253836, 128.5786126187788), //지도 중심좌표
			level: 5 //지도 확대레벨
		};
		...
		// 마커가 표시될 위치입니다 
		var markerPosition  = new kakao.maps.LatLng(35.867635335352716, 128.58494297636113); //선교사 스윗즈주택
		var markerPosition2  = new kakao.maps.LatLng(35.874750619480714, 128.57220229880883); //서부 오미(味)가미(味)거리
		var markerPosition3  = new kakao.maps.LatLng(35.876803095295024, 128.5778621160305); //인동촌 아나고골목
